...
namespace XCrossCropImage.Droid.SourceCode.XCropImage
{
    public class HighlightView
    {
        ...
        private void Init()
        {
            ...
            _resizeDrawableWidth = ContextCompat.GetDrawable(CrossCurrentActivity.Current.Activity, XFCrossCropImage.Android.Resource.Drawable.camera_crop_width);
            _resizeDrawableHeight = ContextCompat.GetDrawable(CrossCurrentActivity.Current.Activity, XFCrossCropImage.Android.Resource.Drawable.camera_crop_height);
        }
